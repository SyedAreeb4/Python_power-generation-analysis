...
class GeothermalScreen:
    def __init__(self, parent):
        self.parent = parent
        self.top = tk.Toplevel(parent)
        self.top.title("Geothermal Power Plant")
    ...
    def create_widgets(self):
        ...
        ttk.Button(frame, text="Calculate", command=self.calculate_geothermal_cost, style='TButton').pack(pady=20)
    ...
    def calculate_geothermal_cost(self):
        try:
