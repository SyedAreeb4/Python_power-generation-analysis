...
class HydroScreen:
    def __init__(self, parent):
        ...
        self.top.title("Hydro Power Plant")
        self.top.geometry("600x800")
        self.top.configure(bg='lightgreen')  # Light green color
    ...
    def create_widgets(self):
        ...
        ttk.Button(frame, text="Calculate", command=self.calculate_hydro_cost, style='TButton').pack(pady=20)
