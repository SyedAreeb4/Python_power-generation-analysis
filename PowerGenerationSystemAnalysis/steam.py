...
class SteamScreen:
    def __init__(self, parent):
        ...
        self.top.title("Steam Power Plant")
    ...
    def create_widgets(self):
        ...
        ttk.Button(frame, text="Calculate", command=self.calculate_steam_cost, style='TButton').pack(pady=20)
